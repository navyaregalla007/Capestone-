...
def get_scatter_plot(entered_site,payload_range):
    ...
    if entered_site == 'ALL': 
        ...
        title='Realtionship between payload and launch outcome for all sites ')
        return fig
    else:
        # return the outcomes piechart for a selected site
        ...
        y='class', 
        color="Booster Version Category", 
        title=f'Realtionship between payload and launch outcome for site :{entered_site} ')
        return fig
...
#Best F9 Booster version: FT: has highest launch success rate
